            ...
            <div className="mt-10 lg:mt-[60px] flex lg:flex-row flex-col items-center lg:justify-between lg:items-end gap-4 mb-5 lg:mb-0">
                <div className="w-[80%] md:w-[50%] flex flex-col lg:items-start items-center">
                    <p className="text-neutral text-center lg:text-start tracking-tight">
                        ...
                        procedimentos para que seu processo seja o mais
                        tranquilo e rápido. Uma consultoria completa para você e
                        sua família não ter nenhuma preocupação na sua viagem.
                    </p>
                    <div>
                    ...
                    >
                        <div className="flex flex-col">
                            <h2 className="text-white w-[90%] mb-2 text-3xl sm:text-[44px] font-semibold ">
                                Realize o seu sonho com <br /> a ajuda da Tirar
                                Visto!
                            </h2>
                            <p className="text-white font-light">
                                Com um serviço profissional, você não terá dor
                                de cabeça para todo o processo do visto e
                                entrevistas no consulado.
                            </p>
                        </div>
                    </div>
                    <Image
